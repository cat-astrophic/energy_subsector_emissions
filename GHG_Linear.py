...
X_Energy = data[['GDP_per_capita', 'Population_Density', 'Renewables', 'HDD', 'CDD']]
X_Commercial = data[['GDP_per_capita', 'Population_Density', 'Renewables', 'HDD', 'CDD']]
X_Residential = data[['GDP_per_capita', 'Population_Density', 'Renewables', 'HDD', 'CDD']]
X_Industrial = data[['GDP_per_capita', 'Population_Density', 'Renewables', 'HDD', 'CDD']]
X_Transportation = data[['GDP_per_capita', 'Population_Density', 'Renewables', 'HDD', 'CDD']]
...
file = open('C:/Users/User/Documents/Data/Regression_Outputs/Linear/energy_model.txt', 'w')
...
file = open('C:/Users/User/Documents/Data/Regression_Outputs/Linear/commercial_model.txt', 'w')
...
file = open('C:/Users/User/Documents/Data/Regression_Outputs/Linear/residential_model.txt', 'w')
...
file = open('C:/Users/User/Documents/Data/Regression_Outputs/Linear/industrial_model.txt', 'w')
...
file = open('C:/Users/User/Documents/Data/Regression_Outputs/Linear/transportation_model.txt', 'w')
...
file = open('C:/Users/User/Documents/Data/Regression_Outputs/Linear/electric_model.txt', 'w')
...
file = open('C:/Users/User/Documents/Data/Regression_Outputs/Linear/fugitive_model.txt', 'w')
...
GDP_df.to_csv('C:/Users/User/Documents/Data/Regression_Outputs/Linear/gdp_forecast.txt', index = False)
...
PD_df.to_csv('C:/Users/User/Documents/Data/Regression_Outputs/Linear/pd_ff_forecast.txt', index = False)
...
for state in States:
    ...
    for i in range(6):
        try:
            temp.append(max(0, lag_val + beta['GDP_per_capita']*GDP_df['forecasted_gdp_per_capita'][idx][i] + beta['Population_Density']*PD_df['forecasted_PD'][idx][i] + beta['Renewables']*PD_df['forecasted_FF'][idx][i] + beta[state]))
            lag_val = temp[len(temp)-1]
        except:
            temp.append(max(0, lag_val + beta['GDP_per_capita']*GDP_df['forecasted_gdp_per_capita'][idx][i] + beta['Population_Density']*PD_df['forecasted_PD'][idx][i] + beta['Renewables']*PD_df['forecasted_FF'][idx][i]))
            lag_val = temp[len(temp)-1]
...
energy_forc_df.to_csv('C:/Users/User/Documents/Data/Regression_Outputs/Linear/ENERGY_GHG_FORECAST.txt', index = False)
...
plt.savefig('C:/Users/User/Documents/Data/Regression_Outputs/Linear/historical.eps')
...
plt.savefig('C:/Users/User/Documents/Data/Regression_Outputs/Linear/forecasts_all.eps')
...
plt.xlabel('Year')
plt.ylabel('GHG Emissions in Mt CO2 Equivalent')
plt.savefig('C:/Users/User/Documents/Data/Regression_Outputs/Linear/all_states_model.eps')
...
commercial_forc_df.to_csv('C:/Users/User/Documents/Data/Regression_Outputs/Linear/commercial_GHG_FORECAST.txt', index = False)
...
residential_forc_df.to_csv('C:/Users/User/Documents/Data/Regression_Outputs/Linear/residential_GHG_FORECAST.txt', index = False)
...
industrial_forc_df.to_csv('C:/Users/User/Documents/Data/Regression_Outputs/Linear/industrial_GHG_FORECAST.txt', index = False)
...
transportation_forc_df.to_csv('C:/Users/User/Documents/Data/Regression_Outputs/Linear/transportation_GHG_FORECAST.txt', index = False)
...
electric_forc_df.to_csv('C:/Users/User/Documents/Data/Regression_Outputs/Linear/electric_GHG_FORECAST.txt', index = False)
...
fugitive_forc_df.to_csv('C:/Users/User/Documents/Data/Regression_Outputs/Linear/fugitive_GHG_FORECAST.txt', index = False)
...
plt.savefig('C:/Users/User/Documents/Data/Regression_Outputs/Linear/subsector_plots.eps')
...
plt.savefig('C:/Users/User/Documents/Data/Regression_Outputs/Linear/agg_subsector_v_sector.eps')
...
adj_r2_df.to_csv('C:/Users/User/Documents/Data/Regression_Outputs/Linear/adjusted_rsquared.txt', index = False)
...
plt.ylabel('GHG Emissions in Mt CO2 Equivalent')
plt.legend(loc = 8, ncol = 1)
plt.savefig('C:/Users/User/Documents/Data/Regression_Outputs/Linear/forcecasts_with_historical_data.eps')
...
file = open('C:/Users/User/Documents/Data/Regression_Outputs/Linear/validation_results.txt', 'w')
...
# Add titles and save
plt.title('Comparison of Aggregated Forecasts at the Subsector Level\nand the Forecast for the Energy Sector\n(Linear GDP Model)', loc = 'center', fontsize = 12, fontweight = 40, color = 'black')
plt.xlabel('Year')
plt.ylabel('GHG Emissions in Mt CO2 Equivalent')
plt.legend(loc = 8, ncol = 1)
plt.savefig('C:/Users/User/Documents/Data/Regression_Outputs/Linear/forcecasts_with_historical_data_linear.eps')
